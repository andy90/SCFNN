...
int main(int argc,char *argv[]) {
    ...
    for (istep = 0; istep < nstep; istep++){
        ...
        vector<float> Eext(3);
        Eeffct[2] = -total_dipole[2] / (boxlength[0]*boxlength[1]*boxlength[2]) * 4 * M_PI;
        Eext[2] = Eeffct[2];
        Eext[2] += Ez;
        ...
        */
        compute_force_GT(rij, vecrij, force, massO, massH, parameters2_OO, parameters2_OH, parameters2_HO, parameters2_HH, parameters4_OOO, parameters4_OOH, parameters4_OHH, parameters4_HHO, parameters4_HOO, xO_scaling, xH_scaling, net_forceGT);
        /*
