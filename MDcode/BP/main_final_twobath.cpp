...
int main(int argc,char *argv[]) {
    ...
    net_forceGT = torch::jit::load("models/traced_trained_model_BP.pt");
    ...
    for (istep = 0; istep < nstep; istep++){
        ...
        while (wxyz_diff > 0.0005){
            ...
            compute_wannier_peturb(rij, pos_rotatedO, wxyz_mapped_rotated_peturb, EO_rotated, EH_rotated, parameters2_OO_w, parameters2_OH_w, parameters4_OO_w, parameters4_OH_w, net_wannier_peturb);
        ...
        compute_force_peturbO(rij, pos_rotatedO, fO_peturb, EO_rotated, EH_rotated, parameters2_OO_w, parameters2_OH_w, parameters4_OO_w, parameters4_OH_w, net_force_peturb_O); // for oxygen
        ...
        */
        compute_force_GT(rij, vecrij, force, massO, massH, boxlength, parameters2_OO, parameters2_OH, parameters2_HO, parameters2_HH, parameters4_OOO, parameters4_OOH, parameters4_OHH, parameters4_HHO, parameters4_HOO, xO_scaling, xH_scaling, net_forceGT);
        /*
